<template>
  <view class="wrapper">
    <u-navbar leftText="分包商进度汇总" bgColor="rgb(0 0 0 / 0%)" leftIconColor="#fff" :autoBack="true"></u-navbar>
    <view class="content">
      <view class="pad"></view>
      <view class="search">
...
export default {
  ...
  methods: {
    ...
    tdClick(item) {
      console.log(item);
      uni.navigateTo({
        url: `/pages/schedule/customActuallyFinish2?isOk=1&id=${item.pkId}&name=${item.name}&endTime=${this.endTime}`,
      });
    },
    currentChange(e) {

<template>
  <view class="wrapper">
    ...
    <view class="sticky">
      ...
      <view class="search" v-if="!isOk">
        <view class="search-item" v-if="!isOk">
          <easy-select ref="easySelect" size="mini" class="easySelect" :value="nowCustom" @selectOne="selectOne"
    ...
    <view class="content">
      ...
      <view class="table_detail table_empty" :class="{ 'table_height': !isOk, 'table_height2': isOk }"
        v-if="current === 1">
...
export default {
  ...
  methods: {
    ...
    selectOne(e) {
      ...
      this.detailTypeList=[]
      this.detailtype=""
      this.nowCustom = e.options.label;

<template>
	<view class="wrapper">
		<u-navbar leftText="月度计划" bgColor="rgb(0 0 0 / 0%)" leftIconColor="#fff" :autoBack="true"></u-navbar>
		<view class="sticky">
			...
			<view class="search">
				...
				<view class="search-item">
					<easy-select ref="easySelect" size="mini" class="easySelect" :value="nowMonth" @selectOne="selectOne3"
						:options="monthList"></easy-select>
				</view>

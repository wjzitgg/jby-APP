<template>
	<view class="wrapper">
		<u-navbar leftText="年度计划" bgColor="rgb(0 0 0 / 0%)" leftIconColor="#fff" :autoBack="true"></u-navbar>
		<view class="sticky">
          ...
          ></easy-select>
				...
				<view class="search-item" v-if="current === 1">
					<easy-select ref="easySelect" size="mini" class="easySelect" :value="contractName" @selectOne="selectOne4"
						:options="contractList"></easy-select>
				</view>
			</view>
			<view class="search" v-if="current === 1">
				<view class="search-item">
					<easy-select ref="easySelect2" size="mini" class="easySelect" :value="detailtype" @selectOne="selectOne3"
		...
		<view class="content">
			<view class="table_detail table_empty" v-if="current === 0">
				...
				<!-- <u-empty v-if="list1.length&&list1.length < 5" style="height: 50%" mode="data" text="没有更多了"
          icon="/static/image/tableNoMore.png"></u-empty> -->

<template>
  <view style="height:100%">
    ...
    <view class="content">
      <view class="table_detail table_empty table_height1" v-if="current === 0">
      ...
      <u-empty v-if="list1.length" mode="data" text="没有更多了" icon="/static/image/tableNoMore.png" :style="{top: list1.length>6?'':'calc(100% - 400rpx)'}"></u-empty>
      <u-empty
        v-else
        style="height: 100%"
        mode="data"
    ...
    <view class="table_detail table_empty table_height1" v-if="current === 1">
      ...
      <u-empty v-if="list2.length" mode="data" text="没有更多了" icon="/static/image/tableNoMore.png" :style="{top: list2.length>6?'':'calc(100% - 400rpx)'}"></u-empty>
      <u-empty
        v-else
        style="height: 100%"
        mode="data"

<template>
  <view class="wrapper">
    ...
    <view class="conntent">
      <view class="table_detail table_height2 table_empty">
        <!--  -->
          ...
          <view class="info-item mb-20">
            ...
            <u--form labelPosition="left" :borderBottom='true'>
              ...
              <u-form-item label="使用部位" labelWidth='80'>
                <view>{{nowClick.consumeItemName}}</view>
              </u-form-item>
            </u--form>
          </view>

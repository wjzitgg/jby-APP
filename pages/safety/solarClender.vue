<template>
  <view class="calendar-wrapper">
    ...
    <view :class="{ hide: !monthOpen }" class="content" :style="{ height: height }">
      <view :style="{ top: positionTop + 'rpx' }" class="days">
        <view class="item" v-for="(item, index) in dates" :key="index">
          ...
          ></view> -->
          <u-icon name="file-text" v-if="isMarkDay(item.year, item.month, item.date) && item.isCurM" color="#43cf7c"
    ...
    <view class="weektoggle" @click="toggle">
      ...
      <u-icon name="arrow-down" v-if="!monthOpen" color="#bbb" size="28"></u-icon>
    ...
    selectOne(i, event) {
      ...
      if (selectD > curTime) {
        if (this.disabledAfter) {
          ...
          // console.log("-------------------111-------xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx")
          // console.log(date)
          // console.log("-------------------111-------xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx")
          // this.choose = date;
          if (this.choose == date) {
        ...
        // console.log("-------------------222-------xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx")
        // console.log(date)
        if (this.choose == date) {
          this.choose = ""
        } else {

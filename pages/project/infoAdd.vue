		...
		<view class="content">
              ...
              <u-radio-group v-model="value">
              	...
              	<u-radio label="否" :name='false'></u-radio>
					...
					<view class="add-inputs">
						...
						<view class="inputs-content">
							<u--textarea v-model="rowData.itemName" placeholder="请输入内容" autoHeight maxlength="25"
								border="none"></u--textarea>
						</view>
					</view>
					<!-- <view class="add-inputs">
            ...
            ></u-input> -->
					...
					<view class="add-inputs">
						...
						<view class="inputs-content">
							<u--textarea v-model="rowData.investorName" placeholder="请输入内容" autoHeight maxlength="25"
								border="none"></u--textarea>
						</view>
					</view>
					<view class="add-inputs">
						<view class="inputs-label">监理单位</view>
						<view class="inputs-content">
							<u--textarea v-model="rowData.supervisorName" placeholder="请输入内容" autoHeight maxlength="25"
								border="none"></u--textarea>
						</view>
					</view>
					<view class="add-inputs">
						<view class="inputs-label">设计院</view>
						<view class="inputs-content">
							<u--textarea v-model="rowData.designName" placeholder="请输入内容" autoHeight maxlength="25"
								border="none"></u--textarea>
						</view>
					</view>
					<view class="add-inputs">
						<view class="inputs-label">施工集团</view>
						<view class="inputs-content">
							<u--textarea v-model="rowData.contractorName" placeholder="请输入内容" autoHeight disabled maxlength="25"
								border="none"></u--textarea>
			...
			preserve() {
				...
				// that.$nextTick(() => {
					let data = {
						...
						itemName: that.rowData.itemName,
						investorName: that.rowData.investorName,
						designName: that.rowData.designName,
						supervisorName: that.rowData.supervisorName,
						supervisorName: that.rowData.supervisorName,
					};
					...
					// if (this.rowData.itemTitle == "新增项目概况") {
					//   this.$api.addProject(data).then((res) => {
					//     uni.hideLoading();
					//     if (res.code == 200) {
					...
					that.$api.projProjectUpdate(data).then(res => {
						uni.hideLoading();
						if (res.code == 200) {
							let pages = getCurrentPages();
							let prevPage = pages[pages.length - 2]; // 上一页面实例

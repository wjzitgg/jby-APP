    ...
    <u-navbar
      ...
      <view class="detail">
        <view class="card">
          ...
          <view class="list-item bdb" ><view class="label">发放日期:</view><text class="item">{{ showData.settlementTime }}</text></view >
          <view class="list-item bdb" ><view class="label">发放人:</view><text class="item">{{ showData.createUserName }}</text></view >
          <view class="list-item bdb" ><view class="label">发放金额:</view><text class="item">{{ showData.settlementAmount }}</text></view >
        </view>
      </view>

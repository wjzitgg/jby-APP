<template>
  <view class="wrapper">
    ...
    <view class="pad"></view>
    <view class="content">
      <u-list @scrolltolower="scrollTolower" class="u-list" v-if="list.length">
       ...
       <u-empty v-else style="height: 100%" class="u-list" mode="data" text="暂时没有数据哦" icon="/static/image/noData.png"></u-empty>
    </view>
...
export default {
  ...
  methods: {
    ...
    detail(item) {
       uni.navigateTo({ url: `/pages/measure/settingDetail?sup=1&type=1&sendType=${[0,7].includes(item.settleStatus)?1:2}&pkId=${item.pkId}` });
    },
    currentChange(e) {

<template>
	<view style="background: #fff;overflow: auto;" id="html2canvas">
		<table style="width:476px;height:673.6px;border-collapse: collapse; overflow: auto; margin: 0 auto" :id="'tables'+index1" v-for="(item1,index1) in tableList" :key="key + index1">
			<tr v-for="(item, idx) in item1.evaluateUrl" :key="idx" style="" v-show="item.status">
